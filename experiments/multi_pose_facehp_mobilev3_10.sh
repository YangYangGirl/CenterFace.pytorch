...
CUDA_VISIBLE_DEVICES=0 python main.py --val_intervals 5 --head_conv 24 --task multi_pose --arch mobilev3_10 --dataset facehp --exp_id 1203_bifpn_obj600_face_hp_mobilev3_10_800_800_bs8_5e-4 --batch_size 12 --master_batch 12 --lr 5e-4  --gpus 0 --num_workers 4 --num_epochs 300 --lr_step 90,120
