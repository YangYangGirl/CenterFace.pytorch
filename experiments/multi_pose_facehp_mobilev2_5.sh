#!/bin/bash
cd ../src
CUDA_VISIBLE_DEVICES=0 python main.py --arch mobilev2_5 --dataset facehp --exp_id 1030_s_face_hp_mobilev2_5_640_640 --batch_size 8 --master_batch 8 --lr 5e-4  --gpus 0 --ltrb  --num_workers 4 --num_epochs 140 --lr_step 90,120
