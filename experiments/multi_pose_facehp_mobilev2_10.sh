...
CUDA_VISIBLE_DEVICES=0 python main.py --val_intervals 5 --task multi_pose --arch mobilev2_10 --dataset facehp  --exp_id 1112_face_hp_mobilev2_10_640_640_bs12_5e-4 --batch_size 12 --master_batch 12 --lr 1.25e-5  --gpus 0 --num_workers 4 --num_epochs 300 --lr_step 90,120,160