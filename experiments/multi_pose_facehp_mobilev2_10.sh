...
CUDA_VISIBLE_DEVICES=2 python main.py --val_intervals 5 --task multi_pose --arch mobilev2_10 --dataset facehp  --exp_id 1115_se_face_hp_mobilev2_10_800_800_bs12_1e-4 --batch_size 12 --master_batch 12 --lr 1e-4  --gpus 2 --num_workers 4 --num_epochs 300 --lr_step 90,120