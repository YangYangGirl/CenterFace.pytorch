...
CUDA_VISIBLE_DEVICES=0 python main.py --task multi_pose --arch shufflenetv2_10 --dataset facehp --exp_id 1112_face_hp_shufflenetv2_10_800_800_bs12_head64_5e-5 --batch_size 12 --master_batch 12 --lr 5e-5  --gpus 0 --num_workers 4 --num_epochs 300 --lr_step 90,120