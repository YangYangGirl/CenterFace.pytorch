...
CUDA_VISIBLE_DEVICES=1 python main.py --val_intervals 200 --head_conv 24 --task multi_pose_whole --arch mobilev3_10 --dataset wholebody --exp_id 1210_obj600_whole_body_mobilev3_10_800_800_bs8_5e-4 --batch_size 8 --master_batch 8 --lr 5e-4  --gpus 0 --num_workers 4 --num_epochs 300 --lr_step 90,120
