...
CUDA_VISIBLE_DEVICES=0 python main.py --val_intervals 5 --task multi_pose --arch mobilev3fast_10 --dataset facehp  --exp_id 1114_face_hp_mobilev3fast_10_800_800_bs12_1e-4_s60_120 --head_conv 24 --batch_size 12 --master_batch 12 --lr 1e-4  --gpus 0 --num_workers 4 --num_epochs 300 --lr_step 60,120