...
CUDA_VISIBLE_DEVICES=3 python main.py --val_intervals 5 --task multi_pose --arch  vovnet_10 --dataset facehp  --exp_id 1113_face_hp_vovnet_10_800_800_bs12_5e-4 --batch_size 12 --master_batch 12 --lr 5e-4  --gpus 3 --num_workers 4 --num_epochs 300 --lr_step 90,120