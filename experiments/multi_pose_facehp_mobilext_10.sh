...
CUDA_VISIBLE_DEVICES=0 python main.py --val_intervals 5 --task multi_pose --arch mobilext_10 --dataset facehp  --exp_id 1112_face_hp_mobilext_10_800_800_bs12_5e-4 --batch_size 6 --master_batch 6 --lr 5e-4  --gpus 0 --num_workers 4 --num_epochs 300 --lr_step 90,120,160