        ...
        while (True):
            ...
            if re.search('jpg', img_path):
                if not os.path.exists(os.path.join(self.images_path, img_path)):
                    print(os.path.join(self.images_path, img_path))
                    continue
                # init image
                image=self.image()
